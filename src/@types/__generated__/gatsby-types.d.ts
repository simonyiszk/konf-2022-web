...
declare namespace GatsbyTypes {
	...
	type RemoteFileFit = "cover" | "fill" | "outside" | "contain";

	type RemoteFileFormat = "auto" | "jpg" | "png" | "webp" | "avif";
	...
	type RemoteFileLayout = "fixed" | "fullWidth" | "constrained";

	type RemoteFilePlaceholder = "dominantColor" | "blurred" | "none";
	...
	type ContentfulSponsorLogo = ContentfulReference &
		ContentfulEntry &
		Node & {
			readonly contentful_id: Scalars["String"];
			readonly id: Scalars["ID"];
	...
	type ContentfulParagraph = ContentfulReference &
		...
		Node & {
			...
			readonly childrenContentfulParagraphContentTextNode: Maybe<
				ReadonlyArray<Maybe<contentfulParagraphContentTextNode>>
			>;
	...
	type ContentfulSponsorLogoSortInput = {
		readonly fields: Maybe<
			ReadonlyArray<Maybe<ContentfulSponsorLogoFieldsEnum>>
		>;
		readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
	};
	...
	type contentfulParagraphContentTextNodeSortInput = {
		readonly fields: Maybe<
			ReadonlyArray<Maybe<contentfulParagraphContentTextNodeFieldsEnum>>
		>;
		readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
	};
			...
			Pick<ContentfulSponsorLogo, "name" | "link" | "sponsorshipGrade"> & {
				readonly image: Maybe<
					Pick<ContentfulAsset, "gatsbyImageData"> & {
						readonly file: Maybe<
							Pick<ContentfulAssetFile, "contentType" | "url">
						>;
						readonly svg: Maybe<
							Pick<
								InlineSvg,
